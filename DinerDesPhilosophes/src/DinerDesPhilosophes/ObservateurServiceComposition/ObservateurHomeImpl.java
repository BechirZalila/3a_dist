 ...
 *  OMG IDL3 IDL:DinerDesPhilosophes/ObservateurHome:1.0 home type.
 * 
 *  This class inherits from the generated home executor skeleton class
 *  defined by OMG CIDL DinerDesPhilosophes.ObservateurServiceComposition.ObservateurHome_impl
 * 
 *  @author OpenCCM CIF_Jimpl Compiler.
 */
public class ObservateurHomeImpl
     extends DinerDesPhilosophes.ObservateurServiceComposition.ObservateurHome_impl
{
    // ==================================================================
    //
    // Internal states.
    ...
    create_executor_segment(int segid) 
    {
        ...
        {
            default :
                return new DinerDesPhilosophes.ObservateurServiceComposition.ObservateurImpl();
        }
    }
    ...
    create_home() 
    {
            return new DinerDesPhilosophes.ObservateurServiceComposition.ObservateurHomeImpl();
    }
